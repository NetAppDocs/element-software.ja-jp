...
summary: GetSSLCertificate メソッドを使用すると、クラスタのストレージノードで現在アクティブになっている SSL 証明書を取得できます。 
---
= GetSSLCertificate
:icons: font
:imagesdir: ../media/
...
[role="lead"]
「 GetSSLCertificate 」メソッドを使用すると、クラスタのストレージノードで現在アクティブになっている SSL 証明書を取得できます。
