...
NOTE: の使用の詳細については、 SolidFire オールフラッシュストレージの概念に関するコンテンツを参照してください link:../concepts/concept_data_manage_volumes_solidfire_quality_of_service.html#qos-policies["QoS ポリシー"] 個々のボリュームではなく 。
