...
. NetAppサポートサイトのページから、インストールに対応したOVAまたはISOをダウンロードしlink:https://mysupport.netapp.com/site/products/all/details/element-software/downloads-tab["Element ソフトウェア"^]ます。新しいOVAには更新されたSSL証明書が含まれています。
+
