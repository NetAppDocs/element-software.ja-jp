...
* 複数のストレージノードを追加する場合は、の制限を確認しておく必要があります link:https://docs.netapp.com/us-en/hci/docs/concept_hci_clusters.html#authoritative-storage-clusters["権限のあるクラスタです"^] 複数のストレージクラスタをサポート
+
...
* link:https://docs.netapp.com/us-en/hci/docs/concept_hci_clusters.html#authoritative-storage-clusters["権限のあるクラスタです"^]
