...
[role="lead"]
管理ノードをバージョン 11.0 以降から管理ノードバージョン 12.3.1 または 12.3 にアップグレードできます。
...
NOTE: 管理ノード 12..1 では、機能の変更やバグの修正は行われていません。管理ノード 12.3 をすでに実行している場合は、これを 12.3.1 にアップグレードする必要はありません。
